# -*- coding: utf-8 -*-
#
# cbapi documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'CarbonBlackAPI-PythonBindings.tex', u'cbapi Documentation',
...
man_pages = [
    (master_doc, 'carbonblackapi-pythonbindings', u'cbapi Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'CarbonBlackAPI-PythonBindings', u'cbapi Documentation',
     author, 'CarbonBlackAPI-PythonBindings', 'One line description of project.',
     'Miscellaneous'),
]
